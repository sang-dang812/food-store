        ...
        <div class="top-links">
            <div class="container">
                <ul class="row links">
                    ...
                    <li class="col-xs-12 col-sm-4 link-item"><span>2</span><a href="#">Chọn món ăn</a></li>
                ...
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-7 col-md-7 col-lg-9">
                        <div class="bg-gray restaurant-entry">
                            <div class="row">
                                <?php $ress= mysqli_query($db,"SELECT rs_id, title, image,address,res_category.c_name FROM restaurant, res_category WHERE restaurant.c_id = res_category.c_id");
									      while($rows=mysqli_fetch_array($ress))
										  {
													 ...
													 echo' <div class="col-sm-12 col-md-12 col-lg-8 text-xs-center text-sm-left">
															...
															<div class="entry-dscr">
																<h5><a href="dishes.php?res_id='.$rows['rs_id'].'" >'.$rows['title'].'</a></h5> <span>'.$rows['address'].'</span></br><span>Category: '.$rows['c_name'].'</span>
